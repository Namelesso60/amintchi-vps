...
# 6. CRÉATION DU SCRIPT (ADAPTÉ POUR RENDER)
# La modification est ici : on utilise ${PORT:-10000}
# Cela signifie : "Utilise le port donné par Render, sinon utilise 10000"
RUN echo '#!/bin/bash' > /home/amintchi/start.sh && \
    ...
    echo 'echo "Lancement de NoVNC sur le port ${PORT:-10000}..."' >> /home/amintchi/start.sh && \
    echo 'websockify --web=/usr/share/novnc/ ${PORT:-10000} localhost:5900' >> /home/amintchi/start.sh && \
